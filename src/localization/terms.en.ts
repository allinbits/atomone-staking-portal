...
# **1. Introduction**  
By accessing and/or using the staking features available via [https://staking.atom.one](https://staking.atom.one) (the “Interface”) utilizing the tools related to staking provided through the Interface, and interacting with the Protocol (the underlying system comprising the AtomOne user logic, staking mechanics, and any associated smart contract or infrastructure that support the User's staking activities) related to staking, User (“you”) agree(s) that: (i) User has read and understood these Staking Terms, specifically covering staking activities; and (ii) User has read and agrees to be bound to these Staking Terms, the [Atom.One Website Terms](https://atom.one/terms), the [Atom.One Governance dApp Terms](https://gov.atom.one/terms), the accompanying [Privacy Policy](https://staking.atom.one/terms) (collectively the “AtomOne Terms”), which set forth the legally binding terms and conditions governing User's use of any Site, Interface or Services provided by provided by All in Bits, Inc., a Delaware corporation (the “operator,” “we,” or “us”), including the staking activities described herein for AtomOne Staking.

We reserve the right to modify or amend these Staking Terms or the AtomOne Terms at our sole discretion from time to time. The “Date Effective” specified on any AtomOne Terms indicates the date on which the Terms were last modified. Please review these Terms periodically to ensure you are aware of and in compliance with the most current version. Any revision to the Terms shall take effect immediately upon such revised Terms being made accessible via the Interface. Such revised Terms shall be binding on the User, and by continuing to access and/or use the staking features of the Interface, the User shall be deemed to agree to and accept the revised Terms. These Terms are intended to work in conjunction with the AtomOne Terms that govern your use of the Interface or Protocol(s) as a whole. Please ensure that you have read all the AtomOne Terms. 
...
AtomOne Staking provides Users with a non-custodial Interface for staking ATONE tokens on the AtomOne blockchain. Staking refers to the User's act of staking ATONE tokens through the Interface, interacting with the Protocol, or utilizing the features provided by the AtomOne Staking Platform. By Staking, users participate in securing the AtomOne network, participate in governance and may receive rewards in return. 

This process requires users to connect a compatible wallet and interact with the blockchain. Transactions and staking operations are irreversible and publicly recorded on the blockchain. 

We do not operate validator nodes, provide staking or node management services, or have access to users' private keys or funds. Staking interactions occur directly between users and validators, facilitated by smart contracts on the AtomOne blockchain. By using the Service, you authorize Validators to perform tasks associated with your staked Digital Assets (assets that are compatible with the Protocol and are specified through the Interface) which may include block validation, consensus, and governance activities.

1. **Wallet Requirement and Access:** In order to access and/or use the Interface and its associated functions including access and/or use of the Protocols via the Interface, Users will first be required to connect a compatible wallet (e.g., Keplr, Leap, Cosmostation) that supports ATONE tokens via the Interface. Your use of a non-custodial wallet provider is governed by the applicable terms of service of that third party and are not governed by these Terms.   
     
2. **User Responsibilities:** User agrees and acknowledges that AtomOne Staking does not have access to, and cannot withdraw or transfer, any of User's Digital Assets that User may elect to deploy in connection with Staking, and that AtomOne Staking has not rendered any advice and/or made any recommendation in respect of User's participation in Staking. AtomOne Staking does not store private keys or have access to users' funds. You are responsible for the security of your wallet credentials, including private keys and seed phrases, as losing access to these may result in the permanent loss of your staked tokens.  
     
3. **Staking Rewards:** The staking of ATONE through the Interface and/or the Protocol, including accrual of any staking rewards (the “**Rewards**”) will be dealt with in accordance with, and governed by, these Terms. User acknowledges and agrees that nothing in these Terms or in any portal created for the purposes of Staking (the “**Staking Portal**”) imposes any obligation on us to provide any Rewards or continue the operation of any relevant Staking Portal or to continue to make Staking available or constitutes an offer or invitation to subscribe for any tokens, securities or financial products. Users acknowledge they are solely responsible for establishing, providing or procuring, maintaining and supporting any operating environment, software and hardware, digital wallets (including, hardware wallets), facilities, equipment and telecommunications and internet connections necessary to use the Staking Portal and to Stake. Staking Rewards are determined by network protocols and are not guaranteed. Any changes to the staking mechanism or reward structure are determined by AtomOne's governance and are beyond the control of the operator. Staking is not available, and Rewards are not available to be accrued or redeemed or exchanged in any jurisdiction where it would contravene applicable law, or would require AtomOne to comply with any regulatory requirements in that jurisdiction, specific to activities same as or similar to Staking and dealing in crypto currencies. Users must maintain best industry practices in respect of security of the user's wallet and associated private keys utilized in Staking. Users must ensure that they comply, at all times, with all applicable laws in using the Staking Portal. Additional information can be found in the AtomOne Terms.  
     
4. **Governance Participation:** Users may delegate ATONE tokens to Validators of their choice through the AtomOne Staking Interface. By doing so, they support the security and governance of the AtomOne network. Users may earn staking rewards based on the Validator's performance. Validators may deduct a commission from these rewards as set by the Validator. AtomOne does not control Validator commission rates. By staking ATONE, Users may participate in governance directly or inherit votes from Validators. Users acknowledge that staking their tokens may result in them having less control over governance matters if they do not actively participate in the voting process. Users who stake ATONE may participate in AtomOne's governance processes, including voting on proposals, amendments, and DAOs as defined in the AtomOne Constitution. Users may inherit the voting behavior of their chosen Validators if they do not vote directly.  
     
5. **Risks and Limitations:** Users acknowledge that staking ATONE carries the risk of slashing, which may result in the loss of a portion of their staked tokens. Slashing may occur if the Validator fails to meet security requirements or behaves maliciously. Users are responsible for selecting reliable Validators. AtomOne does not endorse or recommend any specific Validator and shall not be liable for any losses resulting from User choices. AtomOne may undergo network changes, upgrades, or experience temporary downtime, which could affect staking. AtomOne is not responsible for any rewards, losses, or impacts resulting from these changes.  
     
6. **Gas Fees:** User acknowledges that using AtomOne Staking may incur network transaction fees (“**Gas Fees**”). Users acknowledge that we have no control over third-party transaction fees or staking rewards. All fees are non-refundable, and User is responsible for ensuring their wallet has sufficient funds to cover any fees required for staking transactions. 

# **3.**  **Your Permission to Use the Interface**  
Subject to these Terms, we hereby grant to you a non-assignable, non-transerable, non-exclusive, worldwide, and royalty-free limited license to use our Staking service. You may not use the Staking service if (a) you are not of legal age in your jurisdiction and do not possess the legal capacity to enter into and be bound by this Staking Agreement, (b) you are not a U.S. or Restricted Person as defined in the General Terms barred from using Staking under the applicable laws of the United States, or other countries, including the country in which you are resident or from which you use Staking, and (c) you do not agree to be legally bound by the terms and conditions of this Staking Agreement in their entirety. Users must comply with all applicable laws and regulations and not be in a jurisdiction where staking or use of the AtomOne network is prohibited. Users are responsible for their own account security and management of their ATONE tokens, including any transactions initiated on the platform. AtomOne or its affiliates are not responsible for lost private keys or unauthorized access to User accounts.
...
By using the Interface, you agree to adhere to the following conditions, ensuring your use of AtomOne's Services remains lawful, respectful, and does not compromise the integrity of the decentralized process:
...
2. **Integrity and Security:**  
   ...
   4. **Automated Access:** You may not use any automated systems (e.g., robots, spiders, or similar mechanisms) to access or gather data from the Interface without express permission from the operator.  
   5. **Malicious Code:** You may not submit content containing malicious computer code, viruses, spyware, or any other harmful or unauthorized technology designed to disrupt or alter the normal function of the Interface.  
   6. **Reverse Engineering:** You may not reverse engineer, decompile, or otherwise attempt to extract the source code of any part of the Interface.  
   7. **Prohibited Devices:** You may not use a modified device to access the Interface if the modification is contrary to the manufacturer's software or hardware guidelines, including disabling hardware or software controls (“jailbreaking”).  
   8. **Encouraging Violations**: You may not encourage or assist anyone in violating these terms.  
   9. **Code of Conduct**: You may not engage in any conduct that violates the code of conduct established by the AtomOne Hub community. Violations of this code of conduct may result in the suspension or permanent loss of access to the Interface.
