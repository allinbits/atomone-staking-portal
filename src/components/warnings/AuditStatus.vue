...
<template>
     <div class="flex flex-row justify-between items-start bg-red-200 w-full py-5 px-5 rounded text-red-400 text-300 gap-8 mb-2" v-if="isSecurityHeaderVisible">
      ...
      <button @click="hideSecurityLabel" class="hover:opacity-50">
